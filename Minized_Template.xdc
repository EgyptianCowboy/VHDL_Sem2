...
## Bank 34
set_property -dict { PACKAGE_PIN R8 IOSTANDARD LVCMOS33 } [get_ports { B    }];  # "R8.ARDUINO_IO0"
set_property -dict { PACKAGE_PIN P8 IOSTANDARD LVCMOS33 } [get_ports { H    }];  # "P8.ARDUINO_IO1"
set_property -dict { PACKAGE_PIN P9 IOSTANDARD LVCMOS33 } [get_ports { G    }];  # "P9.ARDUINO_IO2"
set_property -dict { PACKAGE_PIN R7 IOSTANDARD LVCMOS33 } [get_ports { K    }];  # "R7.ARDUINO_IO3"
