...
HD_PWD='/home/sil/Documents/School/VHDL/Week10/oef/opdr10/opdr10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log opdr103.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source opdr103.tcl
