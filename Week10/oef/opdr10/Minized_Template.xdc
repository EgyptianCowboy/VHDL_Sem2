...
set_property -dict { PACKAGE_PIN R8 IOSTANDARD LVCMOS33 } [get_ports { button    }];  # "R8.ARDUINO_IO0"
set_property -dict { PACKAGE_PIN P8 IOSTANDARD LVCMOS33 } [get_ports { rst    }];  # "P8.ARDUINO_IO1"
set_property -dict { PACKAGE_PIN P9 IOSTANDARD LVCMOS33 } [get_ports { leds[0]    }];  # "P9.ARDUINO_IO2"
set_property -dict { PACKAGE_PIN R7 IOSTANDARD LVCMOS33 } [get_ports { clkotest    }];  # "R7.ARDUINO_IO3"
set_property -dict { PACKAGE_PIN N7 IOSTANDARD LVCMOS33 } [get_ports { F    }];  # "N7.ARDUINO_IO4"
set_property -dict { PACKAGE_PIN R10 IOSTANDARD LVCMOS33 } [get_ports { leds[1]   }];  # "R10.ARDUINO_IO5"
set_property -dict { PACKAGE_PIN P10 IOSTANDARD LVCMOS33 } [get_ports { leds[2]    }];  # "P10.ARDUINO_IO6"
set_property -dict { PACKAGE_PIN N8 IOSTANDARD LVCMOS33 }  [get_ports { leds[3]    }];  # "N8.ARDUINO_IO7"
