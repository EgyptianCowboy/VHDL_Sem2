...
## Bank 34
set_property -dict { PACKAGE_PIN R8 IOSTANDARD LVCMOS33 } [get_ports { inVect[0]    }];  # "R8.ARDUINO_IO0"
set_property -dict { PACKAGE_PIN P8 IOSTANDARD LVCMOS33 } [get_ports { inVect[1]    }];  # "P8.ARDUINO_IO1"
set_property -dict { PACKAGE_PIN P9 IOSTANDARD LVCMOS33 } [get_ports { inVect[2]    }];  # "P9.ARDUINO_IO2"
set_property -dict { PACKAGE_PIN R7 IOSTANDARD LVCMOS33 } [get_ports { outVect[0]    }];  # "R7.ARDUINO_IO3"
set_property -dict { PACKAGE_PIN N7 IOSTANDARD LVCMOS33 } [get_ports { outVect[1]    }];  # "N7.ARDUINO_IO4"
set_property -dict { PACKAGE_PIN R10 IOSTANDARD LVCMOS33 } [get_ports { outVect[2]    }];  # "R10.ARDUINO_IO5"
set_property -dict { PACKAGE_PIN P10 IOSTANDARD LVCMOS33 } [get_ports { outVect[3]    }];  # "P10.ARDUINO_IO6"
set_property -dict { PACKAGE_PIN N8  IOSTANDARD LVCMOS33 } [get_ports { outVect[4]    }];  # "N8.ARDUINO_IO7"
set_property -dict { PACKAGE_PIN M9  IOSTANDARD LVCMOS33 } [get_ports { outVect[5]    }];  # "M9.ARDUINO_IO8"
set_property -dict { PACKAGE_PIN N9  IOSTANDARD LVCMOS33 } [get_ports { outVect[6]    }];  # "N9.ARDUINO_IO9"
set_property -dict { PACKAGE_PIN M10 IOSTANDARD LVCMOS33 } [get_ports { outVect[7]   }];  # "M10.ARDUINO_IO10"
#set_property -dict { PACKAGE_PIN M11 IOSTANDARD LVCMOS33 } [get_ports { output   }];  # "M11.ARDUINO_IO11"
