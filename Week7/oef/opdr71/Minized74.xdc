...
## ---------------------------------------------------------------------------- 
## Bank 35
set_property -dict { PACKAGE_PIN F14 IOSTANDARD LVCMOS33 } [get_ports { pOnder     }];  # "F14.ARDUINO_A0"
set_property -dict { PACKAGE_PIN F13 IOSTANDARD LVCMOS33 } [get_ports { pBoven     }];  # "F13.ARDUINO_A1"
set_property -dict { PACKAGE_PIN F12 IOSTANDARD LVCMOS33 } [get_ports { pBoiler     }];  # "F12.ARDUINO_A2"
...
## Bank 34
set_property -dict { PACKAGE_PIN R8 IOSTANDARD LVCMOS33 } [get_ports { brKetel    }];  # "R8.ARDUINO_IO0"
set_property -dict { PACKAGE_PIN P8 IOSTANDARD LVCMOS33 } [get_ports { tBTemp    }];  # "P8.ARDUINO_IO1"
set_property -dict { PACKAGE_PIN P9 IOSTANDARD LVCMOS33 } [get_ports { tOTemp    }];  # "P9.ARDUINO_IO2"
set_property -dict { PACKAGE_PIN R7 IOSTANDARD LVCMOS33 } [get_ports { tWBoiler    }];  # "R7.ARDUINO_IO3"
set_property -dict { PACKAGE_PIN N7 IOSTANDARD LVCMOS33 } [get_ports { tMaxKetel    }];  # "N7.ARDUINO_IO4"
set_property -dict { PACKAGE_PIN R10 IOSTANDARD LVCMOS33 } [get_ports { tKetel    }];  # "R10.ARDUINO_IO5"
set_property -dict { PACKAGE_PIN P10 IOSTANDARD LVCMOS33} [get_ports { schBPomp    }];  # "P10.ARDUINO_IO6"
set_property -dict { PACKAGE_PIN N8  IOSTANDARD LVCMOS33 } [get_ports { schOPomp    }];  # "N8.ARDUINO_IO7"
