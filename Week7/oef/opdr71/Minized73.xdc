...
## ---------------------------------------------------------------------------- 
## Bank 35
#set_property -dict { PACKAGE_PIN F14 IOSTANDARD LVCMOS33 } [get_ports { outVectC[2]     }];  # "F14.ARDUINO_A0"
#set_property -dict { PACKAGE_PIN F13 IOSTANDARD LVCMOS33 } [get_ports { outVectC[3]     }];  # "F13.ARDUINO_A1"
...
## Bank 34
#set_property -dict { PACKAGE_PIN R8 IOSTANDARD LVCMOS33 } [get_ports { word1[0]    }];  # "R8.ARDUINO_IO0"
#set_property -dict { PACKAGE_PIN P8 IOSTANDARD LVCMOS33 } [get_ports { word1[1]    }];  # "P8.ARDUINO_IO1"
#set_property -dict { PACKAGE_PIN P9 IOSTANDARD LVCMOS33 } [get_ports { word2[0]    }];  # "P9.ARDUINO_IO2"
#set_property -dict { PACKAGE_PIN R7 IOSTANDARD LVCMOS33 } [get_ports { word2[1]    }];  # "R7.ARDUINO_IO3"
set_property -dict { PACKAGE_PIN N7 IOSTANDARD LVCMOS33 } [get_ports { numIn[0]    }];  # "N7.ARDUINO_IO4"
set_property -dict { PACKAGE_PIN R10 IOSTANDARD LVCMOS33 } [get_ports { numIn[1]    }];  # "R10.ARDUINO_IO5"
set_property -dict { PACKAGE_PIN P10 IOSTANDARD LVCMOS33 } [get_ports { numIn[2]    }];  # "P10.ARDUINO_IO6"
set_property -dict { PACKAGE_PIN N8  IOSTANDARD LVCMOS33 } [get_ports { numIn[3]    }];  # "N8.ARDUINO_IO7"
set_property -dict { PACKAGE_PIN M9  IOSTANDARD LVCMOS33 } [get_ports { numOut[0]    }];  # "M9.ARDUINO_IO8"
set_property -dict { PACKAGE_PIN N9  IOSTANDARD LVCMOS33 } [get_ports { numOut[1]    }];  # "N9.ARDUINO_IO9"
set_property -dict { PACKAGE_PIN M10 IOSTANDARD LVCMOS33 } [get_ports { numOut[2]   }];  # "M10.ARDUINO_IO10"
set_property -dict { PACKAGE_PIN M11 IOSTANDARD LVCMOS33 } [get_ports { numOut[3]   }];  # "M11.ARDUINO_IO11"
set_property -dict { PACKAGE_PIN R11 IOSTANDARD LVCMOS33 } [get_ports { sel   }];  # "R11.ARDUINO_IO12"
#set_property -dict { PACKAGE_PIN P11 IOSTANDARD LVCMOS33 } [get_ports { outVectC[1]   }];  # "P11.ARDUINO_IO13"
