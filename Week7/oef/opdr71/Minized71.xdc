...
## Bank 34
set_property -dict { PACKAGE_PIN R8 IOSTANDARD LVCMOS33 } [get_ports { svect(0)    }];  # "R8.ARDUINO_IO0"
set_property -dict { PACKAGE_PIN P8 IOSTANDARD LVCMOS33 } [get_ports { svect(1)    }];  # "P8.ARDUINO_IO1"
set_property -dict { PACKAGE_PIN P9 IOSTANDARD LVCMOS33 } [get_ports { svect(3)    }];  # "P9.ARDUINO_IO2"
set_property -dict { PACKAGE_PIN R7 IOSTANDARD LVCMOS33 } [get_ports { dvect(0)    }];  # "R7.ARDUINO_IO3"
set_property -dict { PACKAGE_PIN N7 IOSTANDARD LVCMOS33 } [get_ports { dvect(1)    }];  # "N7.ARDUINO_IO4"
set_property -dict { PACKAGE_PIN R10 IOSTANDARD LVCMOS33 } [get_ports { dvect(2)    }];  # "R10.ARDUINO_IO5"
set_property -dict { PACKAGE_PIN P10 IOSTANDARD LVCMOS33 } [get_ports { dvect(3)    }];  # "P10.ARDUINO_IO6"
set_property -dict { PACKAGE_PIN N8  IOSTANDARD LVCMOS33 } [get_ports { dvect(4)    }];  # "N8.ARDUINO_IO7"
set_property -dict { PACKAGE_PIN M9  IOSTANDARD LVCMOS33 } [get_ports { dvect(5)    }];  # "M9.ARDUINO_IO8"
set_property -dict { PACKAGE_PIN N9  IOSTANDARD LVCMOS33 } [get_ports { dvect(6)    }];  # "N9.ARDUINO_IO9"
set_property -dict { PACKAGE_PIN M10 IOSTANDARD LVCMOS33 } [get_ports { dvect(7)   }];  # "M10.ARDUINO_IO10"
