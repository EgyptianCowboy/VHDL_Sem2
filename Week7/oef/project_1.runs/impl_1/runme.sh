...
HD_PWD='/home/sil/Documents/School/VHDL/Week7/oef/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log opdr74.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source opdr74.tcl -notrace
