...
HD_PWD='/home/sil/Documents/School/VHDL/Week7/oef/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log opdr74.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source opdr74.tcl
