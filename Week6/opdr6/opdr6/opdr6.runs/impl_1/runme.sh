...
HD_PWD='/home/sil/Documents/School/VHDL/Week6/opdr6/opdr6/opdr6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log opdr64.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source opdr64.tcl -notrace
