...
HD_PWD='/home/sil/Documents/School/VHDL/Week6/opdr6/opdr6/opdr6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log opdr64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source opdr64.tcl
