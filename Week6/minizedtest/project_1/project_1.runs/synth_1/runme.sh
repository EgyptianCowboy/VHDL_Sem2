...
HD_PWD='/home/sil/Documents/School/VHDL/Week6/minizedtest/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log opdr5_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source opdr5_7.tcl
